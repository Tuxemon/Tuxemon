...
def play_sound(game, action):
    ...
    **Examples:**
    ...
    sound = mixer.Sound("resources/sounds/" + filename)
    sound.play()
    

def play_music(game, action):
