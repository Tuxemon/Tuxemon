...
class Body(object):
    """A class that holds sprite, color, and face position data for use with fusing two sprites
    together.
    ...
    **Example:**
    ...
    def load(self, json_data, file=True):
        ...
        **Example:**
        ...
        # Set the color properties from the json data
...
def replace_color(image, original_color, replacement_color):
    """Replaces an RGB color in an image with a different RGB color.

    :param image: A PIL Image() object of the image to replace colors.
    :param original_color: A tuple of the RGB (r, g, b) value of the color to replace.
    :param replacement_color: A tuple of the RGB (r, g, b) value of the new color.
...
def fuse(body, face, save=True, filename=None):
    ...
    **Example:**
    ...
    # Replace the color of the body with the colors of the face.
