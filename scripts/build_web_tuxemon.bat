...
REM pygbag rejects some common audio formats (e.g. mp3).
REM Remove mp3 files from temporary web app copy for compatibility.
if exist "%WEB_APP_DIR%\mods\tuxemon\music" (
  del /s /q "%WEB_APP_DIR%\mods\tuxemon\music\*.mp3" >nul 2>nul
)
