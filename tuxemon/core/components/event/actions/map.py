...
def screen_transition(game, action):
...
def start_cinema_mode(game, action):
...
def stop_cinema_mode(game, action):
...
def play_map_animation(game, action):
    ...
    * position - Can be either an x,y coordinate or "player" to draw the animation at the
    ...
    directory = "resources/animations/tileset"
