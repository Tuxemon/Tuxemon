...
from ... import item
from ... import monster
from .map import screen_transition
from ...map import Map

# Create a logger for optional handling of debug messages.
logger = logging.getLogger(__name__)

def teleport(game, action):
...
def transition_teleport(game, action):
